...
extension KolodaView {
    ...
    func configureCard(_ card: DraggableCardView, at index: Int) {
        ...
        //replacinged all of this...if i need it again, just make it one function.. 
...
//        let linkTxt = dataSource!.koloda(self, linkForCardAt: index)
//        let titleTxt = dataSource!.koloda(self, titleForCardAt: index)
//
//        card.descTextConfigure(descTEXT)
//        card.rankConfigure(rankTEXT)
//        card.authorConfigure(authorEXT)
//        card.cardTitleconfigure(titleTxt)
//        card.cardLinkConfigure(linkTxt)
